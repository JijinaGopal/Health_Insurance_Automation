...
sqlcmd -S LAPTOP-2K6MH8QUSQLEXPRESS -d Health_Insurance -E -i "C:\Users\Administrator\Desktop\Internship\Insurance_Operations\Health Insurance Claims\Automation\Data_Cleaning.sql"  
